...
func enter() -> void:
	...
	Audio.play_spatial_sound( MORPH_AUDIO, player.global_position, true, true, 0.25  )
	pass
...
func exit() -> void: 
	...
	player.velocity.y -= 100
	Audio.play_spatial_sound( MORPH_OUT_AUDIO, player.global_position, true, true, 0.25 )
	pass
...
func handle_input( _event : InputEvent ) -> PlayerState:
	...
	if _event.is_action_pressed( "jump" ):
		if player.is_on_floor():
			...
			Audio.play_spatial_sound( JUMP, player.global_position, true, true, 0.5 )
...
func physics_process( _delta: float ) -> PlayerState:
	...
	if on_floor:
		...
		if player.is_on_floor():
			...
			Audio.play_spatial_sound( LAND, player.global_position, true, true, 0.5 )
	return null
